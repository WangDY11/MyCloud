...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        strategy.setSuperEntityClass("com.vilsale.common.base.BaseEntity");
        strategy.setSuperControllerClass("com.vilsale.common.base.BaseController");
        // 不配置，生成所有表
